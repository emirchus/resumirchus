...
import { ResumeData } from "@/app/builder/utils/validations";
import { ratelimit } from "@/lib/ratelimit";
import { headers } from "next/headers";

// Action para generar resumen
export async function generateSummaryAction(resumeData: ResumeData) {
  try {
    ...
    `,
      prompt: `
      Based on the following resume data, generate a summary for the candidate:
