...
export default function ResumeBuilder() {
  ...
  useEffect(() => {
    ...
    if (savedData) {
      try {
        ...
        aiChat.setInput(parsedData.summary);
      } catch (error) {
  ...
  const removeTechnicalSkill = (index: number) => {
    const updatedSkills = { ...resumeData.skills };
    updatedSkills.technical.splice(index, 1);
    setResumeData((prev) => ({
      ...prev,
      skills: updatedSkills,
    }));
  ...
  return (
    <>
        ...
        <SidebarContent className="p-4">
          ...
          >
            ...
            <TabsContents className="mx-1 mb-1 -mt-2 rounded-sm h-full bg-background">
              ...
              <TabsContent value="experience" className="space-y-4 p-6">
              ...
              <TabsContent value="education" className="space-y-4 p-6">
      ...
      <SidebarInset className="flex flex-1 relative overflow-auto h-[98vh] bg-primary/20">
